...
class Extractions @Inject()(
  ...
  @ApiOperation(value = "Uploads a file for extraction of metadata and returns file id",
    notes = "Saves the uploaded file and sends it for extraction to Rabbitmq. " +
      "If the optional URL parameter run_extractors is set to false, it does not send the file for extraction. " +
      "Does not index the file. Same as upload() except for upload()",
  ...
  @ApiOperation(value = "Uploads a file for extraction using the file's URL",
    notes = "Saves the uploaded file and sends it for extraction. " +
      "If the optional URL parameter run_extractors is set to false, it does not send the file for extraction. " +
