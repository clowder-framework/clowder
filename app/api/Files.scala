...
class Files @Inject()(
  ...
  @ApiOperation(value = "Update technical metadata of a file generated by a specific extractor",
      notes = "Metadata in attached JSON object will describe the file's described resource, not the file object itself. " + 
      " The method will search the entire techincal metadata array for the metadata generated by a specific extractor (using extractor_id provided as an argument) " + 
      "and if a match is found, it updates the corresponding metadata element.",
      responseClass = "None", httpMethod = "POST")
