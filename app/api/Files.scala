...
class Files @Inject() (files: FileService, datasets: DatasetService, queries: QueryService, tags: TagService, dtsrequests:DTSRequestsService )  extends ApiController {
