  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      Routes.javascriptRouter("jsRoutes")(
        ...
        api.routes.javascript.Datasets.listDatasetsCanAdd,
        api.routes.javascript.Datasets.listOutsideCollection,
        ...
        api.routes.javascript.Collections.listCollectionsCanAdd,
        ...
        api.routes.javascript.Collections.listCollections,
