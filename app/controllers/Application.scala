  ...
  def javascriptRoutes = Action { implicit request =>
    Ok(
      Routes.javascriptRouter("jsRoutes")(
        ...
        controllers.routes.javascript.Datasets.getUnattachedSessions,
        controllers.routes.javascript.Datasets.refreshToolList,
        controllers.routes.javascript.Datasets.requestSessionURL,
        controllers.routes.javascript.Datasets.removeSession,
