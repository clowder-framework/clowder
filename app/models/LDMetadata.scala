...
case class UserAgent( id: UUID, typeOfAgent : String, userId: Option[URL]) extends Agent

// Automatic extraction
case class ExtractorAgent( id: UUID, typeOfAgent : String, extractorId: Option[URL]) extends Agent
