...
latex_documents = [
  ('index', 'Clowder.tex', u'Clowder Documentation',
   ur'Innovative Software and Data Analysis (ISDA) \\ National Center for Supercomputing Applications (NCSA)', 'manual'),
]
...
texinfo_documents = [
  ('index', 'Clowder', u'Clowder Documentation',
   u'ISDA', 'Clowder', 'One line description of project.',
   'Miscellaneous'),
]
