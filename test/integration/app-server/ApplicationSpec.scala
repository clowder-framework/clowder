...
class ApplicationSpec extends PlaySpec with ConfiguredApp with FakeMultipartUpload {
  ...
  "The Application API Spec" must {
    ...
    "render index template" in {
      val html = views.html.index(1, 2, 3, 4, 5, 6, 7, 3, "1234567890", "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
      /**
      ...
      contentAsString(html) must include("You can access 6 collections")
      contentAsString(html) must include("You can access 2 datasets")
    }
  }
}
